...
├── index.html
├── app.js
├── work-manager.js      # NEW: Управление работами
├── image-processor.js   # NEW: Обработка изображений
├── image-converter.js   # NEW: Конвертация форматов
├── config.js
├── styles.css
└── glfx.js
...
- `work-manager.js` - управление сохранением и галереей работ
- `image-processor.js` - обработка и оптимизация изображений
- `image-converter.js` - конвертация форматов и создание миниатюр
