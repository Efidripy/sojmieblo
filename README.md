...
- **Обработка изображений**: Использует Sharp для конвертации изображений в WebP
- **Управление файлами**: Утилиты для работы с загруженными файлами
...
- `imageProcessor.js` - обработка изображений на клиенте
- `workManager.js` - управление работами (сохраненными изображениями)

#### Утилиты (utils/)
- `fileManager.js` - управление файлами на сервере
- `imageConverter.js` - конвертация изображений с использованием Sharp
